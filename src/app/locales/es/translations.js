...
const translationsEs = {
    home: {
        welcome: [<React.Fragment key={'welcomeText'}>AUNQUE EL APOCALIPSIS SE VISTA DE SEDA, <br />APOCALIPSIS SE QUEDA...</React.Fragment>],
        intro: [<React.Fragment key={'introText'}>
            ...
            <p>
                Historias de las Tierras Salvajes es un <b>juego de mesa digital</b>, que mezcla una
                ...
                misiones y combates <b>a lo largo de cuatro episodios</b>.
            </p>
        </React.Fragment>]
    },
    cards: {
